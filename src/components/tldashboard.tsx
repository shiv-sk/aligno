...
import TeamLeadAnalyticDashboard from "./teamleadanalytic";

export default function TeamLeadDashboard({ projectId , projectName , userId }: {projectId: string , projectName:string , userId: string}){
        ...
        <div className="min-h-screen">
            <div className="flex flex-col items-center pt-6 pb-16 gap-6">
                ...
                </div>
                {
                    isAnalyticView ? (
                        <div>
                            <TeamLeadAnalyticDashboard projectId={projectId} userId={userId} />
                        </div>
                    ) : (
                        <>
                            <div className="drawer drawer-end md:hidden">
                                ...
                                <div className="drawer-content">
                                    {/* Page content here */}
                                    <ul className="flex justify-between items-center max-w-4xl bg-base-200 rounded-xl shadow-xl py-4 px-6">
